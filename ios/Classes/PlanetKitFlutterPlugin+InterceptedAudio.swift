...
extension PlanetKitFlutterPlugin {
    ...
    func putInterceptedMyAudioBack(call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        guard let audio = getNativeInstance(key: audioId) as? PlanetKitInterceptedAudio else {
...
extension PlanetKitFlutterPlugin: PlanetKitCallInterceptedAudioDelegate {
    public func didIntercept(_ call: PlanetKitCall, audio: PlanetKitInterceptedAudio) {
        addNativeInstance(key: audio.instanceId, instance: audio)
