...
typedef struct planetkit_intercepted_audio_t planetkit_intercepted_audio_t;
typedef void (*planetkit_audio_intercept_cb_t)(void *NULLABLE user_ptr, planetkit_intercepted_audio_t *NONNULL intercepted_audio);
