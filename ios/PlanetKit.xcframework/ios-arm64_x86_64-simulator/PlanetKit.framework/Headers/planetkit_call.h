 ...
 * Intercept audio
 */
kit_bool_t      planetkit_call_put_intercepted_my_audio_back(planetkit_call_t *NONNULL call, planetkit_intercepted_audio_t *NONNULL intercepted_audio);
kit_bool_t      planetkit_call_put_intercepted_my_audio_back_with_params(planetkit_call_t *NONNULL call, uint32_t sample_rate, uint32_t channel, planetkit_audio_sample_type_e sample_type, uint32_t sample_count,
                                                                         int64_t seq, const void *NONNULL data_ptr, int32_t data_len);

kit_bool_t      planetkit_call_enable_intercept_my_audio(planetkit_call_t * NONNULL call, void *NULLABLE audio_intercept_cb_user_ptr, planetkit_audio_intercept_cb_t NULLABLE audio_intercept_cb,
                                                         void * NULLABLE result_user_ptr, planetkit_result_handler_t NULLABLE result_handler);
kit_bool_t      planetkit_call_disable_intercept_my_audio(planetkit_call_t * NONNULL call, void * NULLABLE user_ptr, planetkit_result_handler_t NULLABLE result_handler);
